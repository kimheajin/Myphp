...
<body>
<h2>▶ 회원가입</h2>
<form  name="mem_page" method="post" action="mem_prt.php">
  ...
  <tr>
    ...
    <td>
       <input type="checkbox" name="movie" value="" checked>영화감상 &nbsp;
       <input type="checkbox" name="book" value="" >독서 &nbsp;
       <input type="checkbox" name="shop" value="" >쇼핑 &nbsp;
       <input type="checkbox" name="sport" value="" checked>운동
    </td>
  </tr>
  <tr>
